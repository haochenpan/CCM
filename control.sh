...
#  ssh -n -f -o StrictHostKeyChecking=no -i $sk_path $username@$1 "cp ~/CCM/setup/cassandra2.yaml ~/cassandra/conf/cassandra.yaml"
...
./bin/cqlsh 10.142.0.11 -e "create keyspace ycsb WITH REPLICATION = {'class' : 'SimpleStrategy', 'replication_factor': 5};"
